  ...
  return (
    <footer className="text-gree-600">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4">
        ...
        <div>
          <h4 className="font-bold text-lg mb-3 text-gold-300">Quick Links</h4>
        ...
        <div>
          <h4 className="font-bold text-lg mb-3 text-gold-300">Contact</h4>
        ...
        <div>
          <h4 className="font-bold text-lg mb-3 text-gold-300">Newsletter</h4>
