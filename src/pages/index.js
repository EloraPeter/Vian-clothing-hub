            ...
            <main className="min-h-screen bg-gray-100 relative">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                    ...
                    <section className="relative text-center py-12 sm:py-16 md:py-20 mb-8 sm:mb-12">
                        ...
                        <p className="text-base sm:text-lg text-black mt-4 max-w-2xl mx-auto">
                            Discover Nigeria’s Finest Fashion – Trendy, Authentic, Affordable
                        </p>
                        <Link href="/shop" className="mt-6 inline-block bg-gold-500 text-purple-800 font-semibold px-6 py-3 rounded-lg hover:bg-gold-600 transition-colors text-sm sm:text-base">
                            Shop Now
                        </Link>
                    </section>
                    ...
                    <section className="mb-8 sm:mb-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
                            {categories.map((category) => (
                                ...
                                >
                                    <h3 className="text-lg sm:text-xl font-semibold text-purple-700 text-center">{category.name}</h3>
                                </Link>
                            ))}
                        </div>
                    </section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
                            {newArrivals.map((product) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mt-4">{product.name}</h3>
                    ...
                    {/* About Section */}
                    <section className="bg-gray-100 p-4 sm:p-6 md:p-8 rounded-lg">
                        <h1 className="text-2xl sm:text-3xl font-bold text-purple-700 mb-4 font-playfair-display">
                        ...
                        <p className="text-base sm:text-lg font-semibold text-purple-700 mb-2">🔥 Trendy, Original, and Affordable</p>
                        <p className="text-sm sm:text-md text-gray-600 mb-4">
                        ...
                        <p className="text-sm sm:text-md text-gray-600 mb-4">Shop from our wide collection of:</p>
                        ...
                        <p className="text-base sm:text-lg font-semibold text-purple-700 mb-2">✨ What Makes Vian Clothing Hub Special?</p>
                        <ul className="list-disc list-inside text-gray-600 mb-4 text-sm sm:text-md">
                        ...
                        <p className="text-base sm:text-lg font-semibold text-purple-700 mb-2">🧵 Custom Orders & Bespoke Tailoring</p>
                        <p className="text-sm sm:text-md text-gray-600 mb-4">
                        ...
                        <p className="text-base sm:text-lg font-semibold text-purple-700 mb-2">💄 Beauty, Lifestyle & More</p>
                        <p className="text-sm sm:text-md text-gray-600 mb-4">
